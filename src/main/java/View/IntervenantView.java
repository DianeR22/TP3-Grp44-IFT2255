...
public class IntervenantView {
    ...
    public static void afficherMenuIntervenant() {
        ...
        while (true) {
            ...
            System.out.println("3. Soumettre un nouveau projet de travail");
            ...
            switch (input) {
                ...
                case "2":
                    ...
                    break;
                case "3":
                    // Option pour soumettre un nouveau projet
                    System.out.println("Vous êtes sur la section : Soumettre un nouveau projet de travail !");
    ...
    private static void retour(Scanner scanner) {
        ...
        if (reponse.equalsIgnoreCase("1")) {
            // Retour au menu des intervenants
        } else {
